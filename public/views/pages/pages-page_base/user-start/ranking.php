...
<div class="box font_containers ranking">
    ...
    <div class="ranking_containerList">
        ...
        <?php if($data[3] >=1):?>
            <p class="num">1</p>
            <div class="name_m"><img src="/public/tmp/users/directori_<?php echo$_COOKIE['id_user']?>/ranking/top_1_img_user.jpg" alt=""><p><?php echo$data[0][0]?></p>
        ...
        <?php if($data[3] >=2):?>
            <p class="num">2</p>
            <div class="name_m"><img src="/public/tmp/users/directori_<?php echo$_COOKIE['id_user']?>/ranking/top_2_img_user.jpg" alt=""><p><?php echo$data[0][1]?></p>
        ...
        <?php if($data[3] >=3):?>
            <p class="num">3</p>
            <div class="name_m"><img src="/public/tmp/users/directori_<?php echo$_COOKIE['id_user']?>/ranking/top_3_img_user.jpg" alt=""><p><?php echo$data[0][2]?></p>
        ...
        <?php if($data[3] >=4):?>
            <p class="num">4</p>
            <div class="name_m"><img src="/public/tmp/users/directori_<?php echo$_COOKIE['id_user']?>/ranking/top_4_img_user.jpg" alt=""><p><?php echo$data[0][3]?></p>
        ...
        <?php if($data[3] >=5):?>
            <p class="num">5</p>
            <div class="name_m"><img src="/public/tmp/users/directori_<?php echo$_COOKIE['id_user']?>/ranking/top_5_img_user.jpg" alt=""><p><?php echo$data[0][4]?></p>
