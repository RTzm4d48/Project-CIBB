...
<div id="num_rule_">
    <input type='text' name='num_rule' value='1' id='num_rule' hidden>
</div>
<div id="num_prohibition_">
    <input type='text' name='num_prohibition' value='1' id='num_prohibition' hidden>
</div>
<!--  -->
<div class="section"> 
    <h2>PROHIBICIONES</h2>
...
<input type="submit" name="sb_rules" value="Guardar Cambios" id="" >
</form>
</div>
