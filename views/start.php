...
<body>
    <div class="toolbar">
        <div class="toolbar_edgarAggre">
            ...
            <button class="toolbar_login" onclick="location.href='views/pages/login.php'">Iniciar Sesion</button>
    </div>
    <div class="container">
        ...
        <div class="container_body">
            ...
            <button class="container_body_register" onclick="location.href='views/pages/register.php'">Registrarse</button>
