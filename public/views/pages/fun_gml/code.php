            ...
            <div class="container-register-login">
                ...
                <div class="container-register-login_body">
                    ...
                    <div style="height:auto;" class="container-register-login_body_space-box">
                        <p>Se envio un codigo de verificacion a tu gmail: <?php echo$ex['gmail']?></p><input onclick="resend_code();" class="btn_v_a_code" type="submit" value="Volver a enviar el codigo">
                    </div>
                    <div style="height:auto" class="container-register-login_body_space-box">
                    ...
                    <input onclick="salir();" class="btn_v_a_code" style="width:80%;display:flex; margin:5px auto" type="submit" value="Salir">
                    <script>
                    function salir(){
                        var expiry = new Date();
